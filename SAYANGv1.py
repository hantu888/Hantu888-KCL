...
def loginSC():
	...
	if username =="gembel" and password =="kcl":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Ridwan Kcl')
				menu()
